...
function PhilosophyDashboard({ onBack }) {
  ...
  const loadAllStoredContent = () => {
    ...
    // Load quizzes from all philosophy sub-topics
    philosophySubTopics.forEach(subTopic => {
    ...
    // Load flashcards from all philosophy sub-topics
    philosophySubTopics.forEach(subTopic => {
    ...
    // Load essays from all philosophy sub-topics
    philosophySubTopics.forEach(subTopic => {
        ...
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-4xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
              Philosophy Storage Dashboard
            </h1>
            <p className="text-gray-600 mt-2">View and manage all your stored Philosophy study content</p>
          </div>
          <button
            onClick={onBack}
