...
function ChristianityDashboard({ onBack }) {
  ...
  // Christianity sub-topics
  const christianitySubTopics = [
  ...
  const loadAllStoredContent = () => {
    ...
    // Load quizzes from all christianity sub-topics
    christianitySubTopics.forEach(subTopic => {
    ...
    // Load flashcards from all christianity sub-topics
    christianitySubTopics.forEach(subTopic => {
    ...
    // Load essays from all christianity sub-topics
    christianitySubTopics.forEach(subTopic => {
        ...
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-4xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
              Christianity Storage Dashboard
            </h1>
            <p className="text-gray-600 mt-2">View and manage all your stored Christianity study content</p>
          </div>
          <button
            onClick={onBack}
...
export default ChristianityDashboard; 