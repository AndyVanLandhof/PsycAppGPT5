export const topicData = {
  "ancient-philosophical-influences": {
    ...
    description: "Explore Plato and Aristotle's fundamental contributions to religious thought.",
    difficulty: "Medium",
    subTopics: [
  ...
  "arguments-existence-god": {
    ...
    component: "Philosophy",
    description: "Examine key arguments for God's existence.",
    difficulty: "Hard",
    subTopics: [
  ...
  "religious-experience": {
    ...
    component: "Philosophy",
    description: "Examine the significance of religious experiences.",
    difficulty: "Medium",
    subTopics: [
  ...
  "religious-language": {
    ...
    component: "Philosophy",
    description: "Understand the challenges of describing God.",
    difficulty: "Hard",
    subTopics: [
  ...
  "miracles": {
    ...
    title: "Miracles",
    component: "Philosophy",
    description: "Evaluate arguments for and against miracles.",
    difficulty: "Medium",
    subTopics: [
  ...
  "natural-law": {
    ...
    title: "Natural Law",
    component: "Ethics",
    description: "Study Aquinas' moral framework based on nature and reason.",
    difficulty: "Medium",
    subTopics: [
  ...
  "situation-ethics": {
    ...
    component: "Ethics",
    description: "Examine Fletcher's love-centered ethical theory.",
    difficulty: "Easy",
    subTopics: [
  ...
  "kantian-ethics": {
    ...
    component: "Ethics",
    description: "Understand Kant's approach to moral duties and autonomy.",
    difficulty: "Medium",
    subTopics: [
  ...
  "utilitarianism": {
    ...
    component: "Ethics",
    description: "Study Bentham and Mill's approaches to moral decision-making.",
    difficulty: "Medium",
    subTopics: [
  ...
  "euthanasia": {
    ...
    title: "Euthanasia",
    component: "Ethics",
    description: "Debate moral approaches to end-of-life decisions.",
    difficulty: "Hard",
    subTopics: [
  ...
  "business-ethics": {
    ...
    component: "Ethics",
    description: "Apply ethical theories to corporate behavior.",
    difficulty: "Medium",
    subTopics: [
  ...
  "sexual-ethics": {
    ...
    title: "Sexual Ethics",
    component: "Ethics",
    description: "Consider moral questions around sex, gender, and marriage.",
    difficulty: "Hard",
    subTopics: [
  ...
  "augustine": {
    ...
    description: "Explore Augustine's views on human nature and grace.",
    difficulty: "Hard",
    subTopics: [
  ...
  "death-afterlife": {
    ...
    component: "Christianity",
    description: "Examine Christian teachings on life after death.",
    difficulty: "Medium",
    subTopics: [
  ...
  "knowledge-god": {
    ...
    component: "Christianity",
    description: "Debate ways Christians claim to know God exists.",
    difficulty: "Hard",
    subTopics: [
  ...
  "jesus-christ": {
    ...
    component: "Christianity",
    description: "Explore Christian beliefs about Jesus' nature and purpose.",
    difficulty: "Hard",
    subTopics: [
  ...
  "pluralism": {
    ...
    component: "Christianity",
    description: "Analyze Christian attitudes to other religions.",
    difficulty: "Hard",
    subTopics: [
  ...
  "gender": {
    ...
    component: "Christianity",
    description: "Discuss gender, power and equality in Christian teaching.",
    difficulty: "Hard",
    subTopics: [
  ...
  "secularism": {
    ...
    title: "Secularism",
    component: "Christianity",
    description: "Evaluate how Christianity responds to secular culture.",
    difficulty: "Medium",
    subTopics: [
